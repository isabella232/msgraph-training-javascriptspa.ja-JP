...
1. **./Graph-tutorial/config.example.js** ファイルの名前を **/graph-tutorial/config.js** に変更します。
1. **/Graph-tutorial/config.js** ファイルを編集し、次のように変更します。
...
1. Web ブラウザーを開き、`http://localhost:8080` を参照します。
